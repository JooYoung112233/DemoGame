const ITEM_DATA = {
    ...
    stim_pack:    { id: 'stim_pack', name: '스팀팩', type: 'consumable', value: 35, apBoost: 1, icon: '💉', weight: 0.5 },
    ...
    mutant_sample:{ id: 'mutant_sample', name: '변이 샘플', type: 'valuable', value: 70, icon: '🧬', weight: 0.5 },
...
const LOOT_TABLE = {
    ...
    rare_cache: [
        ...
        { item: 'mutant_sample', chance: 0.25, min: 1, max: 1 },
