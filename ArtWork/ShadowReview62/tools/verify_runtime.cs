...
try{
 foreach(var id in new[]{"district_warden","veteran_scavenger"}){
  ...
  System.IO.File.WriteAllBytes("D:/Demo/ArtWork/ShadowReview62/Runtime_"+id+".png",tex.EncodeToPNG());UnityEngine.Object.DestroyImmediate(tex);
 }
...
System.IO.File.WriteAllText("D:/Demo/ArtWork/ShadowReview62/RuntimeValidation.json",report);return report;
