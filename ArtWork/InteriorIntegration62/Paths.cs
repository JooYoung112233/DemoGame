...
public static class InteriorPaths
{
 public static string Run(){
  ...
  var json=JsonConvert.SerializeObject(rows,Formatting.Indented);File.WriteAllText(Path.GetFullPath("../ArtWork/InteriorIntegration62/PathValidation.json"),json);return json;
 }
}
