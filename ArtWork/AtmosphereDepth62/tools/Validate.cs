...
public static class AtmosphereDepthValidate
{
    public static string Run()
    {
        ...
        try{
            ...
            var added=clone.GetComponentInChildren<PropLight3D>();spawned=added!=null&&Mathf.Approximately(added.GetComponent<Light>().intensity,7.5f);
        ...
        int leaks=UnityEngine.Object.FindObjectsByType<Camera>().Count(c=>c.name=="AtmosphereDepthReviewCamera");
        ...
        string json=JsonConvert.SerializeObject(result,Formatting.Indented);File.WriteAllText(Path.GetFullPath(Path.Combine(Application.dataPath,"../../ArtWork/AtmosphereDepth62/Validation.json")),json);
