...
for i in range(3):
 clip=strips.new_movie('Two-hand single swing - repeat '+str(i+1),str(out/'Kevin_Attack2H01.mp4'),channel=1,frame_start=1+i*48)
...
s.render.image_settings.file_format='FFMPEG';s.render.ffmpeg.format='MPEG4';s.render.ffmpeg.codec='H264';s.render.ffmpeg.constant_rate_factor='HIGH';s.render.filepath=str(out/'TwoHandSwing_Review.mp4')
