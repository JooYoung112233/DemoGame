...
# 바닥(나무판자 — 바닥타일, 썩음/부서짐 포함)
add("바닥","나무판자 바닥","floor_wood_plank",["멀쩡","썩음","부서짐(구멍)"],"1x1","바닥타일","N","P1","바닥 시밍리스")
add("바닥","마룻장(들뜬)","floor_plank_loose",[],"1x1","바닥타일/소품","N","P2")
# 침실 + 침구류
add("침실","침대","prop_bed",["나무","철제"],"1x2","휴식/루팅","Y","P1")
add("침실","매트리스(단독)","prop_mattress",["멀쩡","찢어짐/곰팡이"],"1x2","-","Y","P2")
add("침실","화장대","prop_vanity",["나무"],"1x1","루팅","N","P3")
add("침실","전신거울","prop_mirror_full",[],"1x1","-","Y","P3")
add("침실","이불더미","prop_bedding_pile",[],"1x1","-","N","P3")
add("침구","베개","prop_pillow",[],"1x1","-","N","P3")
add("침구","담요/이불","prop_blanket",["갠것","구겨짐"],"1x1","-","N","P3")
add("침구","시트더미","prop_sheets_pile",[],"1x1","-","N","P3")
add("침구","빨래더미","prop_laundry_pile",[],"1x1","-","N","P3")
# 덧댄/부서진 (판자 보강 — 생존 감성)
add("덧댐/파손","판자로 덧댄 가구","prop_patched_furniture",["책장형","수납형"],"1x1","엄폐/막음","N","P2","부서진 가구를 판자로 보강")
add("덧댐/파손","판자로 막은 문/입구","prop_boarded_doorway",[],"1x1","막힘(영구)","N","P1")
add("덧댐/파손","판자벽/널빤지 보강","prop_plank_boarding",[],"1x1","벽 보강","N","P2")
add("덧댐/파손","부서진 가구 잔해","prop_furniture_debris",["나무","철제"],"1x1","엄폐/잡동","N","P1")
add("덧댐/파손","뒤집힌 가구(바리케이드)","prop_overturned_furniture",["책상","장롱","선반"],"1x1","바리케이드/엄폐","N","P1")
# 주방/가전
...
add("자연","가로수","prop_street_tree",["여름","낙엽","고사"],"1x1","-","N","P1")
add("자연","큰 나무(활엽)","prop_tree_big",["여름","낙엽","고사"],"2x2","-","N","P2")
add("자연","침엽수","prop_tree_pine",[],"1x1","-","N","P3")
add("자연","그루터기","prop_tree_stump",[],"1x1","-","N","P3")
add("자연","쓰러진 나무","prop_tree_fallen",[],"2x1","엄폐/장애","N","P2")
add("자연","덤불/관목","prop_bush",["멀쩡","마름","꽃핌"],"1x1","엄폐","N","P1")
add("자연","생울타리(덤불 울타리)","prop_hedge",["멀쩡","웃자람"],"2x1","경계/엄폐","N","P2")
add("자연","화단(꽃)","prop_flowerbed",["꽃","잡초무성","마름"],"1x1","-","N","P2")
add("자연","화단 경계석","prop_garden_edge",[],"1x1","경계","N","P3")
add("자연","잔디 패치","prop_grass_patch",[],"1x1","바닥타일/소품","N","P2")

# ===== 도시 시설 (Street Furniture 추가분) =====
add("도시시설","육교/보행자 다리","prop_overpass",[],"2x2","통행","N","P3")
add("도시시설","지하철 입구","prop_subway_entrance",[],"2x1","통행","N","P2")
add("도시시설","자전거 거치대","prop_bike_rack",[],"1x1","-","N","P3")
add("도시시설","ATM 부스","prop_atm",["멀쩡","파손"],"1x1","-","N","P3")
add("도시시설","무인 키오스크","prop_kiosk",["켜짐","꺼짐"],"1x1","-","N","P3")
add("도시시설","포장마차","prop_food_cart",[],"2x1","-","N","P3")
add("도시시설","신문 가판대","prop_newsstand",[],"1x1","-","N","P3")
add("도시시설","공중화장실","prop_public_toilet",[],"2x1","-","N","P3")
add("도시시설","가로 시계탑","prop_clock_tower",[],"1x1","-","N","P3")
add("도시시설","분리수거함","prop_recycle_bins",[],"1x1","-","N","P3")
add("도시시설","그늘막/천막","prop_canopy_tent",[],"2x1","-","N","P3")
add("도시시설","가로 파라솔","prop_street_parasol",[],"1x1","-","N","P3")
add("도시시설","정류장 노선도","prop_transit_sign",[],"1x1","-","N","P3")

# ===== 간판 (Signage — 글자 없음, NO Korean text) =====
add("간판","돌출 간판","sign_protruding",["켜짐","꺼짐"],"1x1","발광","N","P1")
add("간판","벽면 대형 간판","sign_wall_large",["켜짐","꺼짐"],"2x1","발광","N","P2")
add("간판","옥상 광고탑","sign_rooftop_tower",["켜짐","꺼짐"],"2x2","발광","N","P2")
add("간판","입간판/A-보드","sign_a_board",[],"1x1","-","N","P2")
add("간판","네온 간판","sign_neon",["켜짐","꺼짐"],"1x1","발광","N","P1")
add("간판","셔터 간판","sign_shutter",[],"2x1","-","N","P2")
add("간판","배너/현수막","sign_banner",["멀쩡","찢김"],"1x2","-","N","P2")
add("간판","메뉴/가격판","sign_menu_board",[],"1x1","-","N","P3")
add("간판","병원 십자 간판","sign_cross",["켜짐","꺼짐"],"1x1","발광","N","P2")
add("간판","약국 간판","sign_pharmacy",["켜짐","꺼짐"],"1x1","발광","N","P2")
add("간판","주유소 가격판","sign_gas",[],"1x1","-","N","P3")
add("간판","역/지하철 표지","sign_station",[],"1x1","-","N","P3")
add("간판","LED 전광판","sign_led",["켜짐","꺼짐"],"2x1","발광","N","P2")
add("간판","대형 빌보드","sign_billboard",["멀쩡","찢김"],"2x2","-","N","P2")
add("간판","깨진/떨어진 간판","sign_broken",[],"1x1","장애","N","P2")
# 데칼(시트형)
...
# LM5 강변 부두 — 2026-06-10 제거(개발 난이도) → 랜드마크 4개 구성. 선적 컨테이너만 일반 공업 프랍으로 흡수(아래).
add("공업","선적 컨테이너","prop_shipping_container",["성함","녹슴"],"2x1","엄폐/막힘","N","P2","옛 LM5에서 이관")
