...
const string output="D:/Demo/ArtWork/TownReview";
...
try{
 ...
 var names=new[]{"Pawnshop","Repair","Medical","Furniture","BlackMarket","Container_Home","TownOverview"};
 for(int index=0;index<names.Length;index++){
  ...
  try{
   ...
   bool east=index==3||index==4;cam.transform.position=new Vector3(east?1f:.48f,1.35f,-1f).normalized*70f;cam.transform.LookAt(Vector3.zero);
