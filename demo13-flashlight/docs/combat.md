...
- **현재값(2026-09-12 후속 피드백):** 걷기 **1.2m/s**, 달리기 **3.6m/s**(×3), 앉아 이동 **0.6m/s**(×0.5). 맵 크기에 비해 느리다는 사용자 요청으로 원본 배속 고정 제약을 해제했다. 실제 속도 연동으로 걷기 약 2.67배·달리기 약 1.57배·앉아 이동 약 1.33배 재생, 애니 배속 상한 2.7.
