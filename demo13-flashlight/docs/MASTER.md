...
| 문서 | 내용 | 상태 |
|------|------|------|
| [`building-interior.md`](building-interior.md) | ⭐ **걸어 들어가는 실내 (3D)** — 같은 맵에서 진입·지붕/벽 가림·층 전환. **2026-09-13 마을 상점 5채 연결**: 최신 분할 내부 모델 101개/배치 131개, Comic B 재질, 15개 잠긴 추가 방. 보행·NPC 대화·20개 접근점 검증. | **Unity 연결 완료 / 추가 방 해금 기능은 후속** |
