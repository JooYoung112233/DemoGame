...
> ⚠️ **v2 신사양으로 대체됨** — 본 §은 구 5탭 구조 기록용.
> **신메커닉: [systems/auction.md](systems/auction.md)** (2단계 미니게임 + 위작/저주, 골드 싱크).
...
위 7.4 참조 (구 사양). **v2 신사양은 [systems/auction.md](systems/auction.md)** — 1단계(비공개 일회 입찰) + 2단계(가격 책정+손님 반응) 미니게임 구조.
