...
const GUILD_HALL_DATA = {
    operations: {
        ...
        stages: [
            ...
            { stage: 10, name: '서브 파견 시간 -30%', desc: '실시간 단축',         effect: { dispatchTimeReduction: 0.3 } },
            { stage: 11, name: '동일구역 +1팀 / 슬롯 +1', desc: '3팀, 총 8슬롯',   effect: { subSlotsBonus: 7, duplicateDispatch: 2 } },
            { stage: 12, name: '🏆 총사령관',         desc: '슬롯 10 + 보상 +25%', effect: { subSlotsBonus: 9, duplicateDispatch: 3, swapDuringRun: true, subRewardBonus: 0.4, mainRewardBonus: 0.45 } }
        ]
    },
    infrastructure: {
        key: 'infrastructure',
