class TownScene extends Phaser.Scene {
    ...
    create() {
        ...
        this._drawAutomationButton();
        this._drawCodexButton();
    ...
    _drawAutomationButton() {
        const gs = this.gameState;
        GuildHallManager.ensureState(gs);
        const stage = gs.guildHall.automation || 0;
        if (stage < 1) return;

        UIButton.create(this, 640, 695, 140, 26, '⚙ 자동화 설정', {
            color: 0x334466, hoverColor: 0x446688, textColor: '#aaccff', fontSize: 11,
    ...
    _drawCodexButton() {
        const gs = this.gameState;
        UIButton.create(this, 790, 695, 100, 26, '📖 도감', {
            color: 0x334455, hoverColor: 0x445566, textColor: '#aaccaa', fontSize: 11,
